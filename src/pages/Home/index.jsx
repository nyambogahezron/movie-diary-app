...
import { FaPlus, FaStarHalfAlt,FaSearch, FaExternalLinkAlt } from 'react-icons/fa';
      ...
      <main>
        <div className='home-header'>
            <form className='movie-search-list'>
              ...
              <div className='search-btn btn'> <FaSearch />  </div>
        ...
        <div className='add-btn'><Link to='/create-new-movie'> <FaPlus /> </Link></div>
      </main>
    </section>
  );
};
